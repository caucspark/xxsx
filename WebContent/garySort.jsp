...
<head>
	...
	content="小象生鲜网是专业的进口生鲜水果食品网络购物平台，为您精选全球3000多种生鲜果蔬品质食材，在体验网上购物新模式的同时享尽各国新鲜美味，小象生鲜网是您悠悦生活的品质之选。">
    <link rel="shortcut icon" herf="./frontpages/xiaoxiang/img/logo.jpg" />
    <link rel="stylesheet" href="./frontpages/xiaoxiang/css/public.css" />
    
     <link rel="stylesheet" href="./frontpages/xiaoxiang/css/index.css" />
     <link rel="stylesheet" href="./frontpages/xiaoxiang/css/nav.css" />
     <link rel="stylesheet" href="./frontpages/xiaoxiang/css/gary.css">
     <link rel="stylesheet" href="./frontpages/xiaoxiang/font/iconfont.css">
...
<!------- 活动、广告位 ------->
       ...
       <div class="wrap ad-item">
        ...
        <div class="mywid">
            ...
            <div class="gary-nav clearfix">
                <div class="lf">
                    <i class="iconfont icon-playfill"></i>
                    所有分类</div>
                <div class="rf ">
                    <ul>
                        <li class="seled"><a href="#">奇异果</a></li>
                        <li><a href="#">车厘子</a></li>
                        <li><a href="#">李</a></li>
                        <li><a href="#">牛油果</a></li>
                        <li><a href="#">提子</a></li>
                        ...
                        <li><a href="#">热带水果</a></li>
                        <li><a href="#">时令水果</a></li>
                        <li type="haha"><a href="#">原籍水果</a></li>
                    </ul>
                </div>
            </div>
            <div class="sortbox">
                <a href="#" class="seled">默认排序
                    <i class="iconfont icon-moreunfold"></i></a>
                <a href="#">销量
                <i class="iconfont icon-moreunfold"></i></a>
                <a href="#">价格
                    <i class="iconfont icon-moreunfold"></i></a>
                <a href="#" class="haha">评论
                    <i class="iconfont icon-moreunfold"></i></a>
            </div>
            <div class="shopitems clearfix">
                <ul>
<!--
                    <li class="items" >
                        <img src="http://img12.yiguoimg.com/d/items/2018/180509/9288722749858985_300.jpg">
                        <div class="newpp">
                            <p>
                                <a href="javascript:;">Zespri佳沛新西兰绿奇异果12个115-135g/个</a>
                            </p>
                            <p>
                                <strong>￥68.8</strong>
                            </p>
                   ...
                   <!-- <li style="width: 100px;height: 100px; background-color: green;" onmouseover="console.log(123)"></li>-->
