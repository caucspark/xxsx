...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" id="veConnect" async="" crossorigin="anonymous" src="js/capture-apps-4.20.1.js"></script>
	...
	<div class="register">
        <div class="wrap">
            <div class="tabbable">
                    ...
                    <div class="tab-pane clearfix active" id="tab1">
                        <div class="fl">
                            ...
                            <p>
                                ...
                                <input class="input input-phone"  name="uid" type="text" id="uid" easyform="length:4-16;char-normal;real-time;" message="用户名必须为4—16位的英文字母或数字" easytip="disappear:lost-focus;theme:blue;" 
                                	ajax-message="用户名已存在!" placeholder="请输入您的用户名" value="">
                                <span></span>
                            </p>
                            ...
                            <p>
                            	...
                            	<!--<a href=""# class="btn-green-l" id="PhoneReg">立即注册</a>-->
                            	 <input value="立即注册" id="zhuceb" this.form.submit() type="submit" style="     cursor: pointer;margin-right:20px; margin-top:20px;    border: 0px;width: 306px;height: 50px;background-color: #008842;    font-family: -webkit-body;font-size: 27px;color: white;">
                            </p>
                ...
                <div class="right">                    
                    我已经注册，现在就 <a class="orange" href="https://login.xiangxiang.com/">登录</a>
